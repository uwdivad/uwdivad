...
**2.75B tokens processed** · **18,079 requests** · **12 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 16,880 | 2.5M | 17.6M | 2.53B |
...
<sub>Updated 2026-07-28 · input/output exclude cache reads</sub>
<!-- usage:end -->
