...
**4.29B tokens processed** · **26,656 requests** · **12 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 25,457 | 2.6M | 23.9M | 4.02B |
...
|---|--:|--:|
| claude-fable-5 | 13.6M | 11,653 |
| claude-opus-4-8 | 4.8M | 4,422 |
| claude-opus-5 | 3.7M | 6,381 |
| claude-sonnet-4-6 | 1.3M | 1,866 |
| claude-sonnet-5 | 479K | 659 |
| gpt-5.5 | 308K | 742 |
| gemini-3-flash-a | 166K | 160 |
| gpt-5.6-sol | 152K | 272 |

</details>

**Last 30 days** — tokens/day, peak 2.1M on Jul 19
...
<sub>Updated 2026-08-12 · input/output exclude cache reads</sub>
<!-- usage:end -->
