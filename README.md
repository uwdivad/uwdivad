...
**7.53B tokens processed** · **45,969 requests** · **17 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 42,692 | 3.4M | 56.1M | 6.86B |
...
<sub>Updated 2026-09-23 · input/output exclude cache reads</sub>
<!-- usage:end -->
