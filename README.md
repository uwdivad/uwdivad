...
**6.92B tokens processed** · **42,206 requests** · **16 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 38,994 | 3.4M | 53.0M | 6.27B |
...
<sub>Updated 2026-09-18 · input/output exclude cache reads</sub>
<!-- usage:end -->
