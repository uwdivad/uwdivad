...
**5.34B tokens processed** · **33,503 requests** · **14 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 32,304 | 3.3M | 36.3M | 5.01B |
...
**Last 30 days** — tokens/day, peak 3.2M on Sep 3
...
<sub>Updated 2026-09-04 · input/output exclude cache reads</sub>
<!-- usage:end -->
