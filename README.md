...
**4.87B tokens processed** · **30,555 requests** · **13 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 29,356 | 2.8M | 28.4M | 4.57B |
...
<sub>Updated 2026-08-26 · input/output exclude cache reads</sub>
<!-- usage:end -->
