...
**2.95B tokens processed** · **19,194 requests** · **12 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 17,995 | 2.5M | 18.5M | 2.73B |
...
<sub>Updated 2026-08-01 · input/output exclude cache reads</sub>
<!-- usage:end -->
