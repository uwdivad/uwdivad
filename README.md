...
**4.81B tokens processed** · **30,337 requests** · **13 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 29,138 | 2.7M | 27.1M | 4.52B |
...
<sub>Updated 2026-08-25 · input/output exclude cache reads</sub>
<!-- usage:end -->
