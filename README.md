...
**2.57B tokens processed** · **17,013 requests** · **11 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 15,814 | 2.5M | 16.6M | 2.36B |
...
<sub>Updated 2026-07-26 · input/output exclude cache reads</sub>
<!-- usage:end -->
