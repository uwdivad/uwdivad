...
**3.30B tokens processed** · **20,596 requests** · **12 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 19,397 | 2.5M | 20.3M | 3.06B |
...
|---|--:|--:|
| claude-fable-5 | 12.4M | 10,529 |
| claude-opus-4-8 | 4.7M | 4,329 |
| claude-opus-5 | 1.3M | 1,538 |
...
**Last 30 days** — tokens/day, peak 3.3M on Jul 4
...
<sub>Updated 2026-08-02 · input/output exclude cache reads</sub>
<!-- usage:end -->
