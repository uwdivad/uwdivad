...
**4.29B tokens processed** · **26,579 requests** · **12 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 25,380 | 2.6M | 23.9M | 4.02B |
...
<sub>Updated 2026-08-11 · input/output exclude cache reads</sub>
<!-- usage:end -->
