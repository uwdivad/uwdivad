...
**2.37B tokens processed** · **16,073 requests** · **11 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 14,874 | 2.5M | 15.8M | 2.17B |
...
|---|--:|--:|
| claude-fable-5 | 9.5M | 7,872 |
| claude-opus-4-8 | 4.3M | 4,001 |
...
<sub>Updated 2026-07-22 · input/output exclude cache reads</sub>
<!-- usage:end -->
