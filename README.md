...
**2.91B tokens processed** · **18,852 requests** · **12 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 17,653 | 2.5M | 18.2M | 2.69B |
...
<sub>Updated 2026-07-30 · input/output exclude cache reads</sub>
<!-- usage:end -->
