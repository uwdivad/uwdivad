...
**7.51B tokens processed** · **45,590 requests** · **16 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 42,370 | 3.4M | 55.8M | 6.84B |
...
<sub>Updated 2026-09-22 · input/output exclude cache reads</sub>
<!-- usage:end -->
