...
**2.58B tokens processed** · **17,110 requests** · **11 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 15,911 | 2.5M | 16.7M | 2.36B |
...
|---|--:|--:|
| claude-fable-5 | 10.2M | 8,583 |
| claude-opus-4-8 | 4.7M | 4,327 |
...
<sub>Updated 2026-07-27 · input/output exclude cache reads</sub>
<!-- usage:end -->
