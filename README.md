...
**6.92B tokens processed** · **42,208 requests** · **16 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 38,996 | 3.4M | 53.0M | 6.27B |
| ⚪ Codex CLI (OpenAI) | 3,040 | 10.2M | 1.2M | 317.6M |
...
| claude-fable-5-1 | 18.9M | 4,304 |
| claude-opus-5 | 5.4M | 10,972 |
...
<sub>Updated 2026-09-19 · input/output exclude cache reads</sub>
<!-- usage:end -->
