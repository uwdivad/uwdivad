...
**5.20B tokens processed** · **32,626 requests** · **13 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 31,427 | 3.2M | 33.2M | 4.89B |
...
|---|--:|--:|
| claude-fable-5 | 21.1M | 15,081 |
| claude-opus-4-8 | 4.9M | 4,721 |
| claude-opus-5 | 4.5M | 7,750 |
...
**Last 30 days** — tokens/day, peak 2.2M on Aug 29
...
<sub>Updated 2026-08-31 · input/output exclude cache reads</sub>
<!-- usage:end -->
