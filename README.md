...
**2.91B tokens processed** · **18,794 requests** · **12 models** · since March 2026

| Agent | Requests | Input | Output | Cache reads |
|---|--:|--:|--:|--:|
| 🟠 Claude Code (Anthropic) | 17,595 | 2.5M | 18.2M | 2.69B |
...
<sub>Updated 2026-07-29 · input/output exclude cache reads</sub>
<!-- usage:end -->
